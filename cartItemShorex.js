                    ...
                    <div>
                        <div className="productRow__header">
                            {port && (
                                <span className="productRow__personalInfo bodyText">
                                    {capitalizeString(port.longName)}
                                </span>
                            )}
                        ...
                        <div className="productRow__body">
                            ...
                            <div className="productRow__col pricing">
                                ...
                                {promotionDiscount > 0 && (
                                    <p key="shoppingcart-item-pricing-promotionDiscount">
                                        <span className="label__col" tabIndex={0}>{`${productPromotionDiscountLabel}:`}</span>
                                        <span className="value__col" tabIndex={0}>
                                            -<CurrencyFormat
                                ...
                                {loyalityDiscount > 0 && (
                                    <p key="shoppingcart-item-pricing-loyalitydiscount">
                                        <span className="label__col" tabIndex={0}>{`${loyaltyDiscountLabel}:`}</span>
                                        <span className="value__col" tabIndex={0}>
                                            -<CurrencyFormat
                                ...
                                >
                                    <span className="label__col" tabIndex={0}>{`${totalLabel}`}</span>
                                    <span className="value__col" tabIndex={0}>
                                        <CurrencyFormat
                                            value={totalPrice}
                                            currencyCode={currencyIso}
